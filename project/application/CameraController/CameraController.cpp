...
void CameraController::Update() {
	...
	if (ImGui::Begin("CameraController")) {
		...
		ImGui::Text(
		    "worldMatrix[0][0]=%f,worldMatrix[0][1]=%f,worldMatrix[0][2]=%f,worldMatrix[0][3]=%f", camera_->GetWorldMatrix().m[0][0], camera_->GetWorldMatrix().m[0][1],
		    camera_->GetWorldMatrix().m[0][2], camera_->GetWorldMatrix().m[0][3]);
		ImGui::Text(
		    "worldMatrix[1][0]=%f,worldMatrix[1][1]=%f,worldMatrix[1][2]=%f,worldMatrix[1][3]=%f", camera_->GetWorldMatrix().m[1][0], camera_->GetWorldMatrix().m[1][1],
		    camera_->GetWorldMatrix().m[1][2], camera_->GetWorldMatrix().m[1][3]);
		ImGui::Text(
		    "worldMatrix[2][0]=%f,worldMatrix[2][1]=%f,worldMatrix[2][2]=%f,worldMatrix[2][3]=%f", camera_->GetWorldMatrix().m[2][0], camera_->GetWorldMatrix().m[2][1],
		    camera_->GetWorldMatrix().m[2][2], camera_->GetWorldMatrix().m[2][3]);
		ImGui::Text(
		    "worldMatrix[3][0]=%f,worldMatrix[3][1]=%f,worldMatrix[3][2]=%f,worldMatrix[3][3]=%f", camera_->GetWorldMatrix().m[3][0], camera_->GetWorldMatrix().m[3][1],
		...
		ImGui::Text(
		    "viewMatrix[1][0]=%f,viewMatrix[1][1]=%f,viewMatrix[1][2]=%f,viewMatrix[1][3]=%f", camera_->GetViewMatrix().m[1][0], camera_->GetViewMatrix().m[1][1], camera_->GetViewMatrix().m[1][2],
		    camera_->GetViewMatrix().m[1][3]);
		ImGui::Text(
