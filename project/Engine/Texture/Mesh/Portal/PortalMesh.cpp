...
void PortalMesh::Update() {
	...
	Camera* activeTextureCamera = textureCamera_ ? textureCamera_ : activeObjectCamera;
...
void PortalMesh::Draw() {
	...
	TextureManager::GetInstance()->GetSrvManager()->SetGraphicsRootDescriptorTable(
	    11, secondaryTextureIndex_ == UINT32_MAX ? Object3dCommon::GetInstance()->GetEnvironmentMapSrvIndex() : secondaryTextureIndex_);
